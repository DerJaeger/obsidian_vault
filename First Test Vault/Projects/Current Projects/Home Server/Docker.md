...
> -   **`INIT_ASSETS`** (default: `1`) Install example configuration file & assets (favicons, ...) to help you get started.
   > 
> -   **`SUBFOLDER`** (default: `null`) If you would like to host Homer in a subfolder, (ex: _[http://my-domain/**homer](http://my-domain/**homer)_**), set this to the subfolder path (ex `/homer`).
    >
